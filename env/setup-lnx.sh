...
sudo -EH apt-get -y install autoconf automake bc bison cpio capnproto flex gettext gperf groff libtool ninja-build pkg-config python python3-pip python3-setuptools rpm tcl texinfo
