...
import 'package:orchid/pages/connect/legacy_connect_button.dart';
...
class LegacyConnectPage extends StatefulWidget {
  static bool allowScrolling = false;

  LegacyConnectPage({Key key}) : super(key: key);

  @override
  _LegacyConnectPageState createState() => _LegacyConnectPageState();
}

class _LegacyConnectPageState
    extends State<LegacyConnectPage> // with SingleTickerProviderStateMixin {
    with
        TickerProviderStateMixin //, AutomaticKeepAliveClientMixin // This breaks things unexpectedly.
{
  ...
  Widget _buildScrollablePageContent() {
    ...
    return SingleChildScrollView(
      physics: LegacyConnectPage.allowScrolling
          ? null
