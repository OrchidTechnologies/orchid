...
class AbiEncode {
  ...
  static String uint128(BigInt value) {
    return value.toUnsigned(128).toRadixString(16).padLeft(32, '0');
  }
  ...
  static String uint8(int value) {
    return value.toUnsigned(8).toRadixString(16).padLeft(2, '0');
  }
...
class AbiEncodePacked {
  ...
  static String uint256(BigInt value) {
    return value.toUnsigned(256).toRadixString(16).trimTo(64).padLeft(64, '0');
  }

  static String uint128(BigInt value) {
    return value.toUnsigned(128).toRadixString(16).trimTo(32).padLeft(32, '0');
  }

  static String uint64(BigInt value) {
    return value.toUnsigned(64).toRadixString(16).trimTo(16).padLeft(16, '0');
  }

  static String int256(BigInt value) {
    return value.toRadixString(16).trimTo(64).padLeft(64, '0');
  }
