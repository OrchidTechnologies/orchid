...
class OrchidAccountConfigV1 {
  ...
  static ParseOrchidIdentityResult parseOrchidIdentity(
    ...
    try {
      ...
      var signer =
          OrchidAccountConfigV0.resolveImportedKey(secret, existingKeys, newKeys);
  ...
  static Future<ParseOrchidAccountResult> parse(
    ...
    try {
      return ParseOrchidAccountResult(
          account: OrchidAccountConfigV0.parseOrchidAccount(config, existingKeys));
    } catch (err) {
      if (v0Only) {
        throw err;
      }
    ...
    return ParseOrchidAccountResult(
        identity: OrchidAccountConfigV1.parseOrchidIdentity(config, existingKeys));
  }
