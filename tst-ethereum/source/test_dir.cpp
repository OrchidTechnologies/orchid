...
namespace orc
{
    ...
    task<int> test_directory()
    {
        ...
        string server_address[NumNodes];
        string server_privkey[NumNodes];
        ...
        for (int i(0); i < 128; i++)
        {
	        ...
	        uint128_t ntokens = 1;
            co_await fund_medallion(endpoint, Address(orchid_address), Address(OrchidToken_addr), Address(directory_addr), Address(server_address[i%NumNodes]), ntokens, raddr);
        }
        
        // 1000000000000000000000000000
        //  7766279631452241920
        // 11553255926290448384
